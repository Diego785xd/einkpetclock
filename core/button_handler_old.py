...
class ButtonHandler:
    """Manages button inputs with debouncing and callbacks (polling-based)"""
    ...
    def __init__(self):
        ...
        self.last_button_state = {
            "return": 1,  # 1 = not pressed (pull-up)
            "action": 1,
            "go": 1
        }
        self.use_polling = True  # Use polling instead of interrupts
        self._setup_gpio()
